...
<ul>
    ...
    {* Sub items. *}
    {if eq( ezpreference( 'admin_navigation_subitems' ), 1 )}
    <li class="enabled {$li_width}">
    <div class="button-bc"><div class="button-tl"><div class="button-tr"><div class="button-br">
        <a href={'/user/preferences/set/admin_navigation_subitems/0'|ezurl} title="{'Hide sub items window.'|i18n( 'design/admin/node/view/full' )}">{'Sub items'|i18n( 'design/admin/node/view/full' )}</a>
    </div></div></div></div>
    </li>
    {else}
    <li class="disabled {$li_width}">
    <div class="button-bc"><div class="button-tl"><div class="button-tr"><div class="button-br">
        <a href={'/user/preferences/set/admin_navigation_subitems/1'|ezurl} title="{'Show sub items window.'|i18n( 'design/admin/node/view/full' )}">{'Sub items'|i18n( 'design/admin/node/view/full' )}</a>
    </div></div></div></div>
    </li>
    {/if}
